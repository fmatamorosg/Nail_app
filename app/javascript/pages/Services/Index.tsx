        ...
        {services.length === 0 ? (
          ...
          <div className="grid grid-cols-3 gap-6">
            {services.map((service) => (
              <div
                key={service.id}
                className="relative rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800"
              >
                ...
                <h2 className="pr-16 text-lg font-bold text-slate-900 dark:text-slate-100">
                  {service.name}
                </h2>
